...
class NewsDatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        val defaultNews = listOf(
            ...
            "INSERT INTO $TABLE_NEWS ($COLUMN_DATE, $COLUMN_CONTENT) VALUES ('2025-02-05', '자존감과 반대되는 수치심은 인생의 목적을 이루려고 할 때 필요한 것이 결핍되면서 생겨나는 ‘좌절감’의 다른 이름이기도 하다. 롤스는 수치심을 ‘능력의 탁월성’의 부재 및 상실에 따른 자연적 수치심과 ‘인격의 탁월성’의 부재 및 상실에서 기인하는 도덕적 수치심으로 구분한다. \n" +
