 ...
 * Use the [ThirtyMinutesSenFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ThirtyMinutesSenFragment : Fragment(R.layout.fragment_thirty_minutes_sen) {
    lateinit var dbManagerDiary: DBManager_diary
    lateinit var sqlitedb: SQLiteDatabase

    lateinit var diarybtn4: Button
    ...
    override fun onViewCreated(view: android.view.View, savedInstanceState: Bundle?) {
        ...
        diarybtn4 = view.findViewById(R.id.diarybtn4)
        ...
        diarybtn4.setOnClickListener {
            ...
            findNavController().navigate(R.id.action_thirtyMinutesSenFragment_to_nav_timed_course)
        }
