 ...
 */
class TenMinutesSentenceFragment : Fragment(R.layout.fragment_ten_minutes_sentence) {
    lateinit var dbManagerDiary: DBManager_diary
    lateinit var sqlitedb: SQLiteDatabase

    lateinit var diarybtn2: Button
    ...
    override fun onViewCreated(view: android.view.View, savedInstanceState: Bundle?) {
        ...
        diarybtn2 = view.findViewById(R.id.diarybtn2)
        ...
        diarybtn2.setOnClickListener {
            ...
            findNavController().navigate(R.id.action_tenMinutesSentenceFragment_to_nav_timed_course)
        }
